...
$this->superevents = array(
    1 => array( 'name' => clienttranslate('Lanternfest'),
    ...
    4 => array( 'name' => clienttranslate('Flood'),
    ...
    8 => array( 'name' => clienttranslate('Sunrise'),
    ...
    9 => array( 'name' => clienttranslate('Assassination Attempt'),
    ...
    10 => array('name' => clienttranslate('Charter'),
    ...
    11 => array('name' => clienttranslate('Hidden'),
